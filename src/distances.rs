...
//! at least `MIN_DENSE_SHARE` of the trees keeps a dense column; a rarer one keeps
...
const MIN_DENSE_SHARE: f64 = 0.25;
...
fn weighted_distances(
    ...
    let min_dense = ((n as f64 * MIN_DENSE_SHARE).ceil() as u32).max(2);
...
#[cfg(test)]
mod tests {
    use super::{NO_COLUMN, TREEDIST_TREES, assign_columns, weighted_distances_split};
    use crate::snapshot::{InternSnap, Snapshots};
